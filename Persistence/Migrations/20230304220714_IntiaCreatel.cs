...
{
    /// <inheritdoc />
    public partial class IntiaCreatel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ConversationsId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ParticipantsId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserConversation", x => new { x.ConversationsId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_AppUserConversation_AspNetUsers_ParticipantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserConversation_ParticipantsId",
